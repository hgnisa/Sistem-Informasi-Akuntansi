...
<?php if($_GET['aksi']=="input"){ ?>
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">Insert Purchase</div>
      <div class="card-body">
                <form action="purchase_input_sql.php?aksi=insert" method="GET" class="form-horizontal row-border">
          ...
          <div class="panel-body">
			  ...
			  <label for="exampleInputEmail1">Supplier</label><br>
                ...
                <select class="form-control m-bot15" name="nama_supplier">
                    <?php
			  ...
			  <label for="exampleInputEmail1">Employee</label><br>
                ...
                <select class="form-control m-bot15" name="nama_employee">
                    <?php
                    $query = mysqli_query($connect, "SELECT * FROM employee");
                    while ($d = mysqli_fetch_array($query)) {
                        ?>
                    <option value="<?php echo $d['nama_employee'];?>"><?php echo $d['nama_employee'] ?></option>
                    <?php } ?>
                  </select>
				</div>
         ...
         <div class="form-group">
            <label for="exampleInputEmail1">Debit</label><br>
                ...
                <select class="form-control m-bot15" name="debit">
                    <?php
                    $query = mysqli_query($connect, "SELECT * FROM account WHERE nama_account='Inventory' ");
                    while ($d = mysqli_fetch_array($query)) {
...
<div class="panel-footer">
  <div class="row">
   <div class="col-sm-6 col-sm-offset-3">
    ...
    <a href="purchase.php" button type="button" class="btn btn-danger">Cancel</button></a>
  </div>
</div>
</div> <!-- panel footer -->
 </form>
...
<?php }else{?>
 <?php
 $id=$_GET['id'];
                                                $query = mysqli_query($connect, "SELECT * FROM pembelian WHERE No_Transaksi=$id");
...
<div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
                <form action="purchase_input_sql.php?aksi=update&id=<?php echo $row['No_Transaksi']; ?>" method="GET" class="form-horizontal row-border">
