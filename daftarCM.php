...
<script type="text/javascript">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">Insert Customer</div>
      <div class="card-body">
       <form action = "insertCM.php" method="post">
          <div class="form-group">
            <label for="exampleInputEmail1">ID Customer</label><br>
            <input class="form-control" type="text" name="id_customer" placeholder="ID">
          </div>
		  <div class="form-group">
            <label for="exampleInputEmail1">Name</label><br>
            <input class="form-control" type="text" name="nama_customer" placeholder="Name">
          </div>
		  <div class="form-group">
            <label for="exampleInputEmail1">Telephone</label><br>
            <input class="form-control" type="text" name="noTelp_customer" placeholder="Telephone">
          </div>
          
          <a><input class="btn btn-primary" type="submit" name="kirim" value ="Insert"></a>
		  <a href="customer.php" button type="button" class="btn btn-danger">Cancel</button></a>
		</form>
      </div>
    </div>
  </div>
