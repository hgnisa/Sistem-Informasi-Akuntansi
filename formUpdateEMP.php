...
<script type="text/javascript">
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
			<?php include "ClassEMP.php";
				$dt = new Employee;
				$dt->TampilSatuDataEMP($_GET['id'])
			?>
				<form action = "updateEMP.php" method="post">
				<div class="form-group">
					<label for="exampleInputEmail1">ID Employee</label><br>
					<input class ="form-control" type="text" name = "id_employee" value="<?php print $dt->id_employee; ?>"><br>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Employee Name</label><br>
					<input class ="form-control" type="text" name = "nama_employee" value="<?php print $dt->nama_employee; ?>"><br>
				</div>
 				<div class="form-group">
					<label for="exampleInputEmail1">Telephone</label><br>
					<input class ="form-control" type="text" name = "noTelp_employee" value="<?php print $dt->noTelp_employee; ?>"><br>
				</div>
 				
				<input class="btn btn-primary" type="submit" name="kirim" value ="Edit">
    			<a href="employee.php" button type="button" class="btn btn-warning">Cancel</button></a>
				</form>
			</div>
