...
<script type="text/javascript">
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
			<?php include "ClassCM.php";
				$dt = new Customer;
				$dt->TampilSatuDataCM($_GET['id'])
			?>
				<form action = "updateCM.php" method="post">
				<div class="form-group">
					<label for="exampleInputEmail1">ID Customer</label><br>
					<input class ="form-control" type="text" name = "id_customer" value="<?php print $dt->id_customer; ?>"><br>
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Customer Name</label><br>
					<input class ="form-control" type="text" name = "nama_customer" value="<?php print $dt->nama_customer; ?>"><br>
				</div>
 				<div class="form-group">
					<label for="exampleInputEmail1">Telephone</label><br>
					<input class ="form-control" type="text" name = "noTelp_customer" value="<?php print $dt->noTelp_customer; ?>"><br>
				</div>
 				
				<input class="btn btn-primary" type="submit" name="kirim" value ="Edit">
    			<a href="customer.php" button type="button" class="btn btn-warning">Cancel</button></a>
				</form>
			</div>
