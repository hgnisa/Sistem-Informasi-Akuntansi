...
<div class="col-md-10">
		<div class="panel panel-info">
			<div class="panel-heading"><center><h2>Purchase</h2></center>
             
        <!-- Gallery Items -->
        <a href="purchase_input.php?aksi=input" class="btn btn-shadow btn-info" >Insert Purchase</i>
                                        ...
                                        <table class="table users-table table-condensed table-hover" >
                                            <thead>
                                                <tr>
													...
													<th class="visible-lg">Supplier</th>
													<th class="visible-lg">Employee</th>
                                                    <th class="visible-lg">Option</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $query = mysqli_query($connect, "SELECT * FROM pembelian");
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="visible-lg"><?php echo $row['Nama_Supplier']; ?></td>
															<td class="visible-lg"><?php echo $row['Nama_Employee']; ?></td>
                                                            <td>
                                                                
                                                               <a href="purchase_input.php?aksi=edit&id=<?php echo $row['No_Transaksi']; ?>" class="btn btn-info">Edit<i class="fa fa-edit"></i></a>
                                                                <a href="purchaseDel.php?id=<?php echo $row['No_Transaksi']; ?>&nama=<?php echo $row['Nama_Barang'];?>" class="btn btn-warning">Delete<i class="fa fa-eraser"></i></a>
                                                            </td>
                                               </tr>
                                                        <?php
                                                    }
