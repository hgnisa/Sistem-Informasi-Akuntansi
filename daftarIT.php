      ...
      <div class="card-body">
       <form action = "insertIT.php" method="post">
          <div class="form-group">
            <label for="exampleInputEmail1">ID Item</label><br>
            <input class="form-control" type="text" name="id_barang" placeholder="ID">
          </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
            ...
            <input class="form-control" type="text" name="stok" placeholder="Stock">
          </div>
          <div class="form-group">
